...
docker build -t lightda-examples-oneapi:2021.2-devel-ubuntu18.04 --build-arg compiler_image=intel/oneapi-hpckit:2021.2-devel-ubuntu18.04 --build-arg CC=icc --build-arg CXX=ipc --build-arg FC=ifort --build-arg FFLAGS="$IFORT_FFLAGS" compiler-tests
