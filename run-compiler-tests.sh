...
docker build -t lightda-examples-gcc:11 --build-arg compiler_image=gcc:11 compiler-tests
docker build -t lightda-examples-gcc:10.2.0 --build-arg compiler_image=gcc:10.2.0 compiler-tests
docker build -t lightda-examples-gcc:10.3.0 --build-arg compiler_image=gcc:10.3.0 compiler-tests
